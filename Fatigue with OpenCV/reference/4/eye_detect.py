...
#wants to.
faceCascadeClassifier = cv2.CascadeClassifier(r"E:\HASCO\project\code\FatigueTests\0_dlib\reference\PythonEyeDetection-master\haarcascade_frontalface_alt.xml")
eyeCascadeClassifier = cv2.CascadeClassifier(r"E:\HASCO\project\code\FatigueTests\0_dlib\reference\PythonEyeDetection-master\haarcascade_eye.xml")
...
def detect_objects(image, objectClassifier, divider=4):
    ...
    small_image = cv2.resize(gray_image, (int(Hist_image.shape[1]/divider),int(gray_image.shape[0]/divider)))
